...
public class A3_ideaNode extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        layoutUp.getChildren().addAll(insert, insertB,findN, findB, deleteB, printB);
    ...
    public void getCoordinates() {
        ...
        {
            rows = 5;
        }else if (dataArray.size() <= 33 && dataArray.size() >= 64){ // if there are 33-64 nodes, then total number of rows would be 6
            rows = 6;
        }
    ...
    public void deleteNode() {
        if(!dataArray.isEmpty()){
            ...
            for(int data : tempArray){
                ...
                int i = this.dataArray.indexOf(data);
